...
| **STEVAL-MKI217V1** adapter, LSM6DSOX + LIS2MDL | 1 | A | heel and pitch under sail, motion and impact at the berth. 0x6A, no clash on this bus. ST's own adapter, chosen because it carries the **interrupt line** that the impact detection depends on - most breakouts route only the bus. DIL-24; it is bolted to structure and wired to J9, so the format costs nothing. The magnetometer stays unconnected. **Mounted rigidly**, unlike the SHT31 - an IMU on a flying lead measures the lead ([A-009](design/A-009-imu-heel-and-motion.md)) | 21,20 | Reichelt `STEVAL-MKI217V1` |
